# На вход программе подаётся строка, содержащая английский текст. Напишите программу, которая подсчитывает общее
# количество артиклей a, an, the и выводит текст в следующем формате:
...
count += s.count('An') + s.count('an')
count += s.count('The') + s.count('the')
